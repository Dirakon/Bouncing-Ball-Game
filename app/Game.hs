...
import MapEditor hiding (Game, MapEditorState, handleKeys, render, update)
import Consts
import MathUtils
import MapEditor hiding (Game, render, handleKeys)




initialStateFromMap ::MapInfo ->  GameState
initialStateFromMap mapInfo=
  Game
    { mainBall = Nothing,
      metaInfo =
        MetaInfo
